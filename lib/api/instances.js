...
(function() {
  var Promise, _, aws, conf, ec2, ec2PromiseClient, instances, prepareInstances,
    slice = [].slice;
  ...
  prepareInstances = function(resp_object) {
    var fields, i, instance, instance_list, j, k, len, len1, len2, ref, ref1, ref2, reservation;
    ...
    if (resp_object.Reservations !== void 0) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        reservation = ref[i];
        ref1 = reservation.Instances;
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          instance = ref1[j];
          instance_list.push(_.pick.apply(_, [instance].concat(slice.call(fields))));
        }
      }
    } else {
      ref2 = resp_object.Instances;
  ...
  instances.create_instance = function(opts) {
    var instance_params, required_params, required_tags, tags, user_data, user_params, user_tags;
    instance_params = {
